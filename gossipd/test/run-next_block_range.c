...
static u32 test_activation;
u32 blake2b_activation(const struct daemon *daemon UNNEEDED)
{
...
int main(int argc, char *argv[])
{
	...
	/* Where the proof of work changed, walking back stops there: anything
	 * funded below it is gossip we would only fetch to ignore. */
	test_activation = 40;
	test_block_range(seeker, 100,
			 100, 100,
			 98, 99,
